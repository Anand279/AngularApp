...
export class CreateinvoiceComponent implements OnInit {
  ...
  SetEditInfo(invoiceno: any) {
    this.service.GetInvDetailbycode(invoiceno).subscribe((res: any) => {
      this.editinvdetail = res;
      for (const element of this.editinvdetail) {
        this.addnewproduct();
      };
    });

    this.service.GetInvHeaderbycode(invoiceno).subscribe((res: any) => {
      let editdata: any;
      editdata = res;
      if (editdata != null) {
  ...
  customerchange() {
    let customercode = this.invoiceform.get("customerId")?.value;
    this.service.GetCustomerbycode(customercode).subscribe((res: any) => {
      let custdata: any;
      custdata = res;
      if (custdata != null) {
  ...
  productchange(index: any) {
    ...
    this.service.GetProductbycode(productcode).subscribe((res: any) => {
      let proddata: any;
      proddata = res;
